            ...
            <div class="game-box__inner">
                <div class="game-canvas">
                    <div class="game-canvas__info">
                        <div id="snake2d-text" class="text" v-if="gameOver">
                            Game Over
                        </div>
                        <VueButton type="button" class="btn-primary">start-game</VueButton>
                    </div>
                    <canvas id="snake2d" class="first-show" width="225" height="390"></canvas>
                </div>
                <div class="game-info">
